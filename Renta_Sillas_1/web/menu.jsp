...
<nav>
  <ul>
    ...
    <li><a href="<%=request.getContextPath()%>/configuracion.jsp"><img src="https://w7.pngwing.com/pngs/257/93/png-transparent-settings-gear-icon-gear-configuration-set-up-thumbnail.png" alt="Icono de confg">Configuración</a></li>
  </ul>
</nav>